...
spec = importlib.util.spec_from_file_location("tmux_flash_interactive", interactive_script_path)
...
def mock_config():
    ...
    config.highlight_colour = "\033[48;5;208m\033[1m"
    config.label_colour = "\033[48;5;142m\033[1m"
